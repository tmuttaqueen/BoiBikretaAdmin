 ...
 * @author User
 */
public class SupplyCard extends GridPane {
    SupplyCard(Supplies supply)
    {
        super();
        ...
        ArrayList<SupplyBooks> list = SupplyBooks.getAllBooks(supply.supply_id);
        ...
        Label total_price = new Label(String.valueOf(supply.total_price));
